...
<script lang="ts">
    ...
    import { deleteLoaiKhieuNai, getLoaiKhieuNais } from '@/services/nhanvien/loaiKhieuNaiService'
        ...
        setup() {
            ...
            const showConfirmPopup = (maLoaiKhieuNai: unknown) => {
                if (typeof maLoaiKhieuNai === 'string') {
                    ...
                    console.error('Lỗi: Mã loại khiếu nại xe không phải chữ', maLoaiKhieuNai)
                }
            }
