    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-evenly m-0 mt-3 mb-3">
            <div class="card-header col-xl-6">
                <h5 class="card-title mb-0">Thêm mới chủ cửa hàng</h5>
            </div>
...
<script lang="ts">
    ...
    export default defineComponent({
        ...
        setup() {
            ...
            onMounted(async () => {
                await Promise.all([fetchQuanHuyens()])
            ...
            const handleThemMoi = async () => {
                ...
                try {
                    ...
                    const response = await addChuCuaHang(formData)
                    if (response.success) {
                        await router.push({
                            name: 'DanhSachNguoiDungView',
